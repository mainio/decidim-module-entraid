...
if ENV["SIMPLECOV"]
  SimpleCov.start do
    ...
    add_filter "/test/"
    add_filter "/tmp/"
    add_filter %r{\A/lib/decidim/[^/]*/engine\.rb}
    add_filter %r{\A/lib/decidim/[^/]*/version\.rb}
    add_filter %r{\A/lib/decidim/[^/]*/admin_engine\.rb}
    add_filter %r{\A/lib/decidim/[^/]*/component\.rb}
    add_filter %r{\A/lib/decidim/[^/]*/participatory_space\.rb}
    add_filter %r{\A/lib/omniauth/[^/]*/test\.rb}
    add_filter %r{\A/lib/generators/templates/[^\.]+\.rb}
  end
